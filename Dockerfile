...
RUN cabal install threadscope hp2pretty
...
CMD tar -cjC /root/.cabal bin/threadscope bin/ghc-events bin/hp2pretty share/x86_64-linux-ghc-7.8.4/threadscope-0.2.7/ | base64
